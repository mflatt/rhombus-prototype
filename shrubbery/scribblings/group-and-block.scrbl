...
@deftech{alternative} sequences. The following grammar summarizes the
abstract structure of a group, ignoring whitespace rules and @litchar{,}
and @litchar{;} separators, where include @deftech{atoms} are individual
@seclink("token-parsing"){tokens}:
