...
(define-annotation-syntax Void (identifier-annotation void? #,(get-empty-static-infos)))
(define-annotation-syntax False (identifier-annotation not #,(get-empty-static-infos)))
(define-annotation-syntax True (identifier-annotation (lambda (x) (and x #t)) #,(get-empty-static-infos)))
