...
@doc(
 ...
 For information about @rhombuslink(definitely, @rhombus(!, ~datum)) as
 a postfix operator, see @rhombus(definitely).
...
@doc(
 ...
 @rhombuslink(definitely, ~bind, @rhombus(!, ~datum)) as a postfix
 operator, see @rhombus(definitely, ~bind).
