...
@doc(
  ...
  annot.macro 'Map.by($map_by)'
  annot.macro 'Map.by($map_by).of($key_annot, $val_annot)'
  annot.macro 'MutableMap.by($map_by)'
){
 ...
 procedures specified by @rhombus(map_by).
...
@doc(
  ...
  fun Map([key :: Any, val :: Any] :: Listable.to_list, ...)
    :: Map
  expr.macro 'Map.by($map_by){$key_val_or_splice, ...}'
  expr.macro 'Map.by($map_by)'
  repet.macro 'Map.by($map_by){$key_repet_or_splice, ...}'
){
 ...
 hashing functions specified by @rhombus(map_by) for keys.
...
@doc(
  ...
  bind.macro 'ReadableMap([$key_expr, $val_bind], ...)'
  bind.macro 'Map.by($map_by){$key_expr: $val_bind, ...}'
  bind.macro 'Map.by($map_by){$key_expr: $val_bind, ..., $rest}'
  bind.macro 'Map.by($map_by)([$key_expr, $val_bind], ...)'
  grammar rest:
    & $map_bind
    $rest_key_bind: $rest_val_bind #,(@litchar{,}) $ellipsis
 ...
 constructed using @rhombus(map_by).
...
@doc(
 ...
 equality and hashing functions specified by @rhombus(map_by).
...
@doc(
  ...
  fun MutableMap([key :: Any, val :: Any] :: Listable.to_list, ...)
    :: MutableMap
  expr.macro 'MutableMap.by($map_by){key_expr: val_expr, ...}'
  expr.macro 'MutableMap.by($map_by)'
){
