...
@doc(
 ...
 Returns a mutable byte string with the same initial content as
 @rhombus(bstr).
...
@doc(
 ...
 Copies bytes from @rhombus(bstr) at @rhombus(src_start) (inclusive) to
 @rhombus(src_end) (exclusive) into @rhombus(dest_str) starting at
 @rhombus(dest_start). The length of @rhombus(dest_str) must be at least 
