...
@doc(
  ...
  grammar stx_pat_bind_term:
    $identifier
    #,(@rhombus(_, ~syntax_pattern_binding))
    '$term'
    ($ stx_pat_bind)
    $other_stx_pat_bind_term

  grammar stx_pat_bind:    
    $identifier #,(@rhombus(::, ~syntax_pattern_binding)) $syntax_class
    $other_stx_pat_bind
){
 ...
 A @rhombus(_, ~syntax_pattern_binding) as a syntax pattern binding
 ...
 When the @rhombus(::, ~syntax_pattern_binding) operator is used to
 ...
 @rhombus(syntax_pattern_binding.macro). }
...
@doc(
  syntax_pattern_binding.macro '_'
  syntax_pattern_binding.macro '$identifier :: $syntax_class'
  syntax_pattern_binding.macro '#{#%parens} ($stx_pat_bind)'
  syntax_pattern_binding.macro '«#{#%quotes} '$stx_pat_bind'»'
){
