...
@doc(
 ...
 The input @rhombus(pattern) is matched to
 @rhombus(id ...: expr) where @rhombus(expr) is a
 @tech{parsed} expression for the right-hand side of
 ...
 sequence must be a syntax object of the form
