...
(define (apply-prefix-direct-operator op form stx track-origin use-sites? checker)
  (call-as-transformer
   stx
   track-origin
   #:use-sites? use-sites?
...
(define (apply-infix-direct-operator op form1 form2 stx track-origin use-sites? checker)
  (call-as-transformer
   stx
   track-origin
   #:use-sites? use-sites?
...
(define (apply-prefix-transformer-operator op op-stx tail track-origin use-sites? checker)
  (define proc (operator-proc op))
  (call-as-transformer
   op-stx
   track-origin
...
(define (apply-infix-transformer-operator op op-stx form1 tail track-origin use-sites? checker)
  (define proc (operator-proc op))
  (call-as-transformer
   op-stx
   track-origin
